...
public class NotesScr : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        noteRectTransform.anchoredPosition = new Vector3(xValue, CalculateYPosition(clickStartTime, fatherJudgeLine.GetComponent<JudgeLineScr>().speed * speedMultiplier, (playStartUnixTime - System.DateTime.UtcNow.Subtract(new System.DateTime(1970, 1, 1, 0, 0, 0, 0)).TotalMilliseconds)), noteRectTransform.transform.position.z);       
    }
